                            ...
                            case 0:
                                return e.abrupt("return", new Promise((function(e, r) {
                                    i.get(t, n, o).then((function(t) {
                                        ...
                                        r("Что-то пошло не так на сервере")
                                    }))
                                })));
                            case 1:
                            case "end":
                ...
                value: function(e, t) {
                    return new Promise((function(n, r) {
                        (new a).post("add-review", {
                            ...
                            r(s.translate("Что-то пошло не так на сервере"))
                        }))
                    }))
                }
            }, {
                ...
                value: function(e, t, n, o) {
                    return new Promise((function(i, u) {
                        (new a).post("feedback", {
                            ...
                            console.log(e), u(s.translate("Что-то пошло не так на сервере"))
                        }))
                    }))
                }
            }]), e
                ...
                value: function(e, t) {
                    ...
                    return new Promise((function(r, o) {
                        (new a).get("available", {
                            ...
                            o(s.translate("Что-то пошло не так на сервере"))
                        }))
                    }))
                }
            }, {
                ...
                value: function() {
                    ...
                    return new Promise((function(t, n) {
                        (new a).get("info-dir", {
                            ...
                            n(s.translate("Что-то пошло не так на сервере"))
                        }))
                    }))
                }
            }, {
                ...
                value: function(e, t) {
                    ...
                    return r && o.push(this.getRequisites()), new Promise((function(e, t) {
                        Promise.all(o).then((function(r) {
                            ...
                            t(s.translate("Что-то пошло не так на сервере"))
                        }))
                    }))
                }
            }, {
                ...
                value: function(e, t, n) {
                    ...
                    return this.inviter && (i.inviter = this.inviter), new Promise((function(e, t) {
                        (new a).post("create", o, i).then((function(n) {
                            ...
                            t({
                                status: "error",
                                msg: s.translate("Что-то пошло не так на сервере")
                            })
                        }))
                    }))
                }
                ...
                value: function(e, t, n, r, o) {
                    return new Promise((function(s, u) {
                        (new i).post("review", {
                            ...
                            u(a.translate("Что-то пошло не так на сервере"))
                        }))
                    }))
                }
            }]), e
                ...
                value: function(e, t) {
                    return new Promise((function(n, r) {
                        (new a).post("upload-card", t, {
                            ...
                            console.log(e), r(s.translate("Что-то пошло не так на сервере\nЗагрузите файл формата png/jpg/jpeg и размером не более 8 Мб"))
                        }))
                    }))
                }
            }]), e
